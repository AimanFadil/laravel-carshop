...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center">NUOVA AUTOMOBILE</h1>
            </div>
            @if ($errors->any())
            ...
            <div class="col-12">
                <form action="{{ route('admin.cars.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prezzo" id="prezzo" value="{{ old('prezzo') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alimentazione" id="alimentazione" value="{{ old('alimentazione') }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descrizione" cols="30" rows="10" id="descrizione"
                            class="form-control @error('descrizione') is-invalid @enderror" required>{{ old('descrizione') }}</textarea>
                        @error('descrizione')
                            <p class="text-danger fw-bold">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="trazione" id="trazione" value="{{ old('trazione') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="porte" id="porte" value="{{ old('porte') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="carrozzeria" id="carrozzeria" value="{{ old('carrozzeria') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cavalli" id="cavalli" value="{{ old('cavalli') }}"
